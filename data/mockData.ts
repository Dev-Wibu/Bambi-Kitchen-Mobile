...
// Extended mock type to allow local-only fields (like imageUrl) used for UI development

export type MockDiscount = Discount & { imageUrl?: string };
...
export const mockDiscounts: MockDiscount[] = [
  {
    ...
    imageUrl:
      "https://t3.ftcdn.net/jpg/04/13/20/54/240_F_413205445_LVqtxEZgBgum4puKbMgNzAmBkdYcUeqf.jpg",
  },

  {
    ...
    imageUrl:
      "https://as1.ftcdn.net/v2/jpg/01/90/77/16/1000_F_190771609_eWrTgzs6Z17CVaUMlSSQdWjayxoLPSqt.jpg",
  },

  {
    ...
    imageUrl:
      "https://as2.ftcdn.net/v2/jpg/03/80/70/97/1000_F_380709730_9LaKo8sNozBEVLPRMjgXxzevut7eSHAS.jpg",
  },
];
