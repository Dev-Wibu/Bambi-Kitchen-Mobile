...
// import type { DishCategory } from "@/interfaces/dishCategory.interface";

// import {

//   transformDishCategoryCreateRequest,

//   transformDishCategoryUpdateRequest,
...
// } from "@/services/dishCategoryService";
...
// export default function DishCategoryManagement() {

//   const [isFormVisible, setIsFormVisible] = useState(false);

//   const [selectedCategory, setSelectedCategory] = useState<DishCategory | null>(null);

//   const [deleteConfirm, setDeleteConfirm] = useState<DishCategory | null>(null);
...
//   const handleDelete = (category: DishCategory) => {
...
//         text2: "Dish category deleted successfully",

//       });

//       queryClient.invalidateQueries({ queryKey: ["/api/dish-category"] });
...
//         text2: "Failed to delete dish category",
...
//         const updateData = transformDishCategoryUpdateRequest({
...
//           text2: "Dish category updated successfully",
...
//         const createData = transformDishCategoryCreateRequest({
...
//           text2: "Dish category created successfully",
...
//           ? "Failed to update dish category"

//           : "Failed to create dish category",
...
//               Are you sure you want to delete the dish category &quot;{deleteConfirm.name}&quot;?
...
//               {categories.map((category: DishCategory) => (
